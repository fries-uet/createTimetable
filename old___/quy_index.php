...
<head>
    ...
    // -------------bonus
    <script src="js/quy_main.js"></script>
    <link rel="stylesheet" href="css/quy_sidebar_mask.css"/>
...
<div id="page" style="padding-top: 55px">
    ...
    <div id="content">
        ...
        <div id="content-left" class="col-lg-3">
            <div id="content-left-header" class="text-center">
                <h3>Môn học</h3>
                <button class="btn btn-block btn-success" id="btnAddSubject">Thêm/Xóa</button>
            </div>
            <div id="content-left-listSubject">
        ...
        <div id="content-right" class="col-lg-9">
            <div>
                ...
                <button id="filterTable" class="glyphicon glyphicon-filter" onclick="sidebarShow('filter-table')"></button>
                <div class="pull-right" style="padding-top: 25px;">
                    <span>Tổng số môn:</span>
                    <span id="soMon">0</span>
                    <span style="margin-left: 25px">Tổng số tín:</span>
                    <span id="soTin">0</span>
                </div>
            </div>
    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper" style="top: 111px">
            <div class="list-group-item list-group-item-success" id="title-listsubject">
                <span>Danh sách môn học</span>
                <span class="btn-remove glyphicon glyphicon-remove" id="closeListSubject"></span></div>
            <ul class="list-group" id="list-subject">
            </ul>
        </div>
    </div>
    <?php include("includes/maskTable.php"); ?>
